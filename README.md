...
Создайте демо-видео приложения (30-60 секунд) для демонстрации возможностей:

```bash
# Автоматическая запись через скрипт
./scripts/record_demo.sh

# Или следуйте инструкциям для ручной записи
# См. scripts/manual_record_guide.md
```

Сценарий демонстрации доступен в `scripts/demo_scenario.md`
